...
% \subsubsection{Comparisons with FCI}

% Full Configuration Interaction provides an exact answer in the limit where the model space represents the full Hilbert space. The listed two-particle results are thus to be considered very close to the exact energy This is demonstrated by the results for $\omega=1$, where FCI provides six trailing zeros to the exact result of $E_0=3$ \cite{taut}. Diffusion Monte-Carlo has overall a five decimal overlap with the FCI result, which demonstrates the fact that DMC successfully projects out the exact ground state.

% As the number of particles increase, the size of the FCI model space blows up. Consequently, the DMC results for $N=6$ and larger are lower than the FCI results, since DMC does not suffer from the same \textit{curse of dimensionality}.

% \subsubsection{Comparisons with SRG}
% 
% Similarity Renormalization Group theory is, unlike VMC, DMC, CCSD and FCI, not variational. This implies that the resulting energy can undershoot the exact energy, which renders conclusions regarding the final energy estimate harder to make. Nevertheless, DMC and SRG are in excellent agreement for higher number of particles.
...
\begin{figure}
 \begin{center}
   \subfigure{\includegraphics[scale=0.4]{../Graphics/OBD/OBD_Q3D/QD2w1_3D.png}} 
   \subfigure{\includegraphics[scale=0.3]{../Graphics/OBD/OBD_Q3D/QD2w1_2D.png}}  \\
   \subfigure{\includegraphics[scale=0.4]{../Graphics/OBD/OBD_Q3D/QD8w1_3D.png}} 
   \subfigure{\includegraphics[scale=0.3]{../Graphics/OBD/OBD_Q3D/QD8w1_2D.png}}  \\
   \subfigure{\includegraphics[scale=0.4]{../Graphics/OBD/OBD_Q3D/QD20w1_3D.png}} 
   \subfigure{\includegraphics[scale=0.3]{../Graphics/OBD/OBD_Q3D/QD20w1_2D.png}}  \\
...
\begin{figure}
 \begin{center}
   ...
   \subfigure{\includegraphics[scale=0.4]{../Graphics/OBD/OBD_Q3D/QD2w001_3D.png}} 
   ...
   \subfigure{\includegraphics[scale=0.4]{../Graphics/OBD/OBD_Q3D/QD8w001_3D.png}} 
