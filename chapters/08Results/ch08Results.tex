...
\begin{figure}
 \begin{center}
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_DMC/dist_out_QDots2c1_3D.png}}
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_DMC/dist_out_QDots6c1_3D.png}} \\
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_DMC/dist_out_QDots12c1_3D.png}}
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_DMC/dist_out_QDots20c1_3D.png}} \\
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_DMC/dist_out_QDots30c1_3D.png}}
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_DMC/dist_out_QDots42c1_3D.png}} \\
...
\begin{figure}
 \begin{center}
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_DMC/dist_out_QDots2c05_3D.png}}
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_DMC/dist_out_QDots6c05_3D.png}} \\
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_DMC/dist_out_QDots12c05_3D.png}}
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_DMC/dist_out_QDots20c05_3D.png}} \\
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_DMC/dist_out_QDots30c05_3D.png}}
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_DMC/dist_out_QDots42c05_3D.png}} \\
...
\begin{figure}
 \begin{center}
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_DMC/dist_out_QDots2c028_3D.png}}
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_DMC/dist_out_QDots6c028_3D.png}} \\
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_DMC/dist_out_QDots12c028_3D.png}}
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_DMC/dist_out_QDots20c028_3D.png}} \\
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_DMC/dist_out_QDots30c028_3D.png}}
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_DMC/dist_out_QDots42c028_3D.png}} \\
...
\begin{figure}
 \begin{center}
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_DMC/dist_out_QDots2c01_3D.png}}
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_DMC/dist_out_QDots6c01_3D.png}} \\
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_DMC/dist_out_QDots12c01_3D.png}}
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_DMC/dist_out_QDots20c01_3D.png}} \\
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_DMC/dist_out_QDots30c01_3D.png}}
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_DMC/dist_out_QDots42c01_3D.png}} \\
...
\begin{figure}
 \begin{center}
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_rad_psort/QDots_2.png}}
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_rad_psort/QDots_6.png}} \\
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_rad_psort/QDots_12.png}}
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_rad_psort/QDots_20.png}} \\
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_rad_psort/QDots_30.png}}
  \subfigure{\includegraphics[scale=0.35]{../Graphics/OBD/OBD_rad_psort/QDots_42.png}} \\
...
\begin{figure}
 \begin{center}
  \subfigure{\includegraphics[scale=0.34]{../Graphics/OBD/OBD_DMC/dist_out_QDots2c001_3D.png}} 
  \subfigure{\includegraphics[scale=0.34]{../Graphics/OBD/OBD_w001/QDots_2.png}} \\
  \subfigure{\includegraphics[scale=0.34]{../Graphics/OBD/OBD_DMC/dist_out_QDots6c001_3D.png}}
  \subfigure{\includegraphics[scale=0.34]{../Graphics/OBD/OBD_w001/QDots_6.png}} \\
  \subfigure{\includegraphics[scale=0.34]{../Graphics/OBD/OBD_DMC/dist_out_QDots12c001_3D.png}} 
  \subfigure{\includegraphics[scale=0.34]{../Graphics/OBD/OBD_w001/QDots_12.png}} \\
  \subfigure{\includegraphics[scale=0.34]{../Graphics/OBD/OBD_DMC/dist_out_QDots20c001_3D.png}}
  \subfigure{\includegraphics[scale=0.34]{../Graphics/OBD/OBD_w001/QDots_20.png}} \\
...
\hline\hline
\ \\
He & \qquad & 0 & \qquad 0 & \qquad $-2.9037^\mathrm{a}$ \\
\ \\
Be & \qquad & 0 & \qquad 0 & \qquad $-14.6674^\mathrm{a}$ \\
\ \\
Ne & \qquad & 0 & \qquad 0 & \qquad $-128.9383^\mathrm{a}$ \\
\ \\
Mg & \qquad & 0 & \qquad 0 & \qquad $-200.054^\mathrm{a}$ \\
\ \\
Ar & \qquad & -524.16(7) & \qquad -527.30(4) & \qquad $-527.544^\mathrm{a}$ \\
\ \\
Kr & \qquad & -2700(5) & \qquad -2749.9(2)
& \qquad $-2752.05498^\mathrm{b}$ \\
\ \\
\end{tabular}
\label{tab:AtomsRes}
\end{center}
...
\begin{figure}
 \begin{center}
   \subfigure{\includegraphics[scale=0.47]{../Graphics/OBD/OBD_Atoms/3D/Helium.png}} 
   \subfigure{\includegraphics[scale=0.34]{../Graphics/OBD/OBD_Atoms/2D/Helium.png}}  \\
   \subfigure{\includegraphics[scale=0.47]{../Graphics/OBD/OBD_Atoms/3D/Neon.png}} 
   \subfigure{\includegraphics[scale=0.34]{../Graphics/OBD/OBD_Atoms/2D/Neon.png}}  \\
   \subfigure{\includegraphics[scale=0.47]{../Graphics/OBD/OBD_Atoms/3D/Argon.png}} 
   \subfigure{\includegraphics[scale=0.34]{../Graphics/OBD/OBD_Atoms/2D/Argon.png}}  \\
   \subfigure{\includegraphics[scale=0.47]{../Graphics/OBD/OBD_Atoms/3D/Krypton.png}} 
   \subfigure{\includegraphics[scale=0.34]{../Graphics/OBD/OBD_Atoms/2D/Krypton.png}}  \\
