...
\begin{figure}
 \begin{center}
  \subfigure{\includegraphics[scale=0.3]{../Graphics/OBD/OBD_pure_radial/radial_out_QDots_odd_1.png}}
  \subfigure{\includegraphics[scale=0.3]{../Graphics/OBD/OBD_pure_radial/radial_out_QDots_odd_05.png}} \\
  \subfigure{\includegraphics[scale=0.3]{../Graphics/OBD/OBD_pure_radial/radial_out_QDots_odd_028.png}}
  \subfigure{\includegraphics[scale=0.3]{../Graphics/OBD/OBD_pure_radial/radial_out_QDots_odd_01.png}} \\
  ...
  \subfigure{\includegraphics[scale=0.3]{../Graphics/OBD/OBD_pure_radial/radial_out_QDots_even_1.png}}
  \subfigure{\includegraphics[scale=0.3]{../Graphics/OBD/OBD_pure_radial/radial_out_QDots_even_05.png}} \\
  \subfigure{\includegraphics[scale=0.3]{../Graphics/OBD/OBD_pure_radial/radial_out_QDots_even_028.png}}
  \subfigure{\includegraphics[scale=0.3]{../Graphics/OBD/OBD_pure_radial/radial_out_QDots_even_01.png}} \\
