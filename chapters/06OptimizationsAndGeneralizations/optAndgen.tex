...
\begin{enumerate}[label=\textbf{(\roman{*})}, ref=(\roman{*}), align=left]
 ...
 \item Linear scaling of run time vs. the number of processors (CPUs) for large simulations. \label{it::opt::parScale}
 \vspace{0.2cm}
\end{enumerate}
}
