...
% 
% Other languages such as Python are interpreted real-time and therefore require no compilation; it instructs as it reads. Although the latter seems like a better solution, it comes at the price of efficiency, a key concept in programming. 
% 
...
\vspace{0.5cm}
\lstinputlisting[language=Python]{../CodeInputs/KeyBoardSuper.py}
...
\clearpage
\lstinputlisting{../CodeInputs/virtualFunctionsC++MAIN.cpp}
